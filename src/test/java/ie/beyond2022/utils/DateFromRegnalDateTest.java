...
public class DateFromRegnalDateTest {
    ...
    public void test_Henry_III_1216_10_30() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(30, 10, 1, "hen", 3);
        assertEquals("1216-10-30", val);
    }

    @Test
    public void test_Henry_III_1217_10_25() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(25, 10, 1, "hen", 3);
        assertEquals("1217-10-25", val);
    }

    @Test
    public void test_Henry_III_1235_12_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 12, 20, "hen", 3);
        assertEquals("1235-12-20", val);
    }

    @Test
    public void test_Henry_III_1236_01_01() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(1, 1, 20, "hen", 3);
        assertEquals("1236-01-01", val);
    }

    @Test
    public void test_Henry_III_1272_11_16() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(16, 11, 57, "hen", 3);
        assertEquals("1272-11-16", val);
    }
    ...
    public void test_Edward_I_1272_11_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 11, 1, "edw", 1);
        assertEquals("1272-11-20", val);
    }

    @Test
    public void test_Edward_I_1272_12_31() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(31, 12, 1, "edw", 1);
        assertEquals("1272-12-31", val);
    }

    @Test
    public void test_Edward_I_1273_1_11() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(11, 1, 1, "edw", 1);
        assertEquals("1273-01-11", val);
    }
    ...
    public void test_Edward_II_1307_07_08() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(8, 7, 1, "edw", 2);
        assertEquals("1307-07-08", val);
    }

    @Test
    public void test_Edward_II_1308_07_07() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(7, 7, 1, "edw", 2);
        assertEquals("1308-07-07", val);
    }

    @Test
    public void test_Edward_II_1317_09_27() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(27, 9, 11, "edw", 2);
        assertEquals("1317-09-27", val);
    }

    @Test
    public void test_Edward_II_1318_03_27() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(27, 3, 11, "edw", 2);
        assertEquals("1318-03-27", val);
    }

    @Test
    public void test_Edward_II_1326_08_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 8, 20, "edw", 2);
        assertEquals("1326-08-20", val);
    }

    @Test
    public void test_Edward_II_1327_01_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 1, 20, "edw", 2);
        assertEquals("1327-01-20", val);
    }
    ...
    public void test_Edward_III_1327_01_25() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(25, 1, 1, "edw", 3);
        assertEquals("1327-01-25", val);
    }

    @Test
    public void test_Edward_III_1328_01_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 1, 1, "edw", 3);
        assertEquals("1328-01-20", val);
    }

    @Test
    public void test_Edward_III_1348_05_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 5, 22, "edw", 3);
        assertEquals("1348-05-20", val);
    }

    @Test
    public void test_Edward_III_1367_09_29() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(29, 9, 41, "edw", 3);
        assertEquals("1367-09-29", val);
    }

    @Test
    public void test_Edward_III_1377_06_21() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(21, 6, 51, "edw", 3);
        assertEquals("1377-06-21", val);
    }
    ...
    public void test_Richard_II_1377_06_22() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(22, 6, 1, "ric", 2);
        assertEquals("1377-06-22", val);
    }

    @Test
    public void test_Richard_II_1378_06_21() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(21, 6, 1, "ric", 2);
        assertEquals("1378-06-21", val);
    }

    @Test
    public void test_Richard_II_1399_09_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 9, 23, "ric", 2);
        assertEquals("1399-09-20", val);
    }
    ...
    public void test_Henry_IV_1399_09_30() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(30, 9, 1, "hen", 4);
        assertEquals("1399-09-30", val);
    }

    @Test
    public void test_Henry_IV_1400_09_29() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(29, 9, 1, "hen", 4);
        assertEquals("1400-09-29", val);
    }
    ...
    public void test_Henry_V_1413_03_21() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(21, 3, 1, "hen", 5);
        assertEquals("1413-03-21", val);
    }

    @Test
    public void test_Henry_V_1414_03_20() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(20, 3, 1, "hen", 5);
        assertEquals("1414-03-20", val);
    }
    ...
    public void test_Henry_VI_1422_09_01() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(1, 9, 1, "hen", 6);
        assertEquals("1422-09-01", val);
    }

    @Test
    public void test_Henry_VI_1423_08_31() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(31, 8, 1, "hen", 6);
        assertEquals("1423-08-31", val);
    }

    @Test
    public void test_Henry_VI_1470_10_10() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(10, 10, 49, "hen", 6);
        assertEquals("1470-10-10", val);
    }

    @Test
    public void test_Henry_VI_1471_04_04() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(4, 4, 49, "hen", 6);
        assertEquals("1471-04-04", val);
    }
    ...
    public void test_Edward_IV_1461_03_04() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(4, 3, 1, "edw", 4);
        assertEquals("1461-03-04", val);
    }

    @Test
    public void test_Edward_IV_1462_03_01() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(1, 3, 1, "edw", 4);
        assertEquals("1462-03-01", val);
    }
    ...
    public void test_Edward_V_1483_05_10() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(10, 5, 1, "edw", 5);
        assertEquals("1483-05-10", val);
    }
    ...
    public void test_Richard_III_1483_06_26() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(26, 6, 1, "ric", 3);
        assertEquals("1483-06-26", val);
    }

    @Test
    public void test_Richard_III_1484_06_25() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(25, 6, 1, "ric", 3);
        assertEquals("1484-06-25", val);
    }
    ...
    public void test_Henry_VII_1485_08_22() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(22, 8, 1, "hen", 7);
        assertEquals("1485-08-22", val);
    }

    @Test
    public void test_Henry_VII_1486_08_21() throws IOException {
        DateFromRegnalDate dateFromRegnalDate = new DateFromRegnalDate();
        String val = dateFromRegnalDate.dateFromRegnal(21, 8, 1, "hen", 7);
        assertEquals("1486-08-21", val);
    }
